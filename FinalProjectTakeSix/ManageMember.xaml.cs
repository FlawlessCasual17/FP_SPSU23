    ...
    public partial class ManageMember : ContentPage {
        ...
        private async void OnClickUpdate(object sender, EventArgs e) {
            if (searchResults != null && searchResults.Any()) {
                var selectedMember = searchResults.FirstOrDefault();
        ...
        private void UpdateMemberInformation(Member selectedMember) {
            ...
            dbService.UpdateMember(selectedMember);
        ...
        private async void OnClickDelete(object sender, EventArgs e) {
            if (searchResults != null && searchResults.Any()) {
                ...
                var result = await DisplayAlert("Delete Member", $"Are you sure you want to delete {selectedMember.UserName}?", "Yes", "No");

                if (result) {
                    // Delete member from the database
                    dbService.DeleteMember(selectedMember.UserId);
        ...
        private void OnMemberSearchTextChanged(object sender, TextChangedEventArgs e) => SearchMember(e.NewTextValue);
        ...
        private void SearchMember(string searchText) {
            ...
            searchResults = dbService.GetMembersBySearchText(searchText);
